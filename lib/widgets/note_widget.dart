...
class _NoteWidgetState extends State<NoteWidget> with AutomaticKeepAliveClientMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return ListenableBuilder(
      ...
      builder: (context, _) {
        final authorUser =
            UserProvider.instance.getUserOrDefault(widget.note.author);
        ...
        if (widget.note.isRepost && widget.note.repostedBy != null) {
          reposterUser =
              UserProvider.instance.getUserOrDefault(widget.note.repostedBy!);
                          ...
                          if (widget.note.isRepost && reposterUser != null)
                            Positioned(
                              ...
                              child: GestureDetector(
                                onTap: () =>
                                    _navigateToProfile(reposterUser!.npub),
                                child: CircleAvatar(
                                  radius: 12,
